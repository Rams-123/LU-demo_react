...
import Logos from "../assets/LU-Logo.png"
...
const Footer = () => {
    return (
        <footer
            className="bg-white text-white dark:bg-neutral-900 border-t dark:border-t-white"
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-10 sm:pt-10 lg:px-8 lg:pt-10">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <div id="logo" className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className={`font-bold text-4xl`}>lu</h1>
                            </div>
                        </div>
                        <p className="text-sm leading-6 ">
                            Learn. Build. Share. Grow <br /> <br />
                            On a Mission to Upskill 10 Million
                            People for Tech Industry with Live Instructors and Amazing
                            Community for Upgrading Together
                        </p>
                ...
                <div className="mt-16 border-t border-gray-900/10 dark:border-white pt-8 sm:mt-20 lg:mt-24">
                    <p className="text-xs leading-5 text-gray-500 dark:text-white">
                        LetsUpgrade EdTech Pvt. Ltd. © 2024
                    </p>
                </div>
            </div>
        </footer>
